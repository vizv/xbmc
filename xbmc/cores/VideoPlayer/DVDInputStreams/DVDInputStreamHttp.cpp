...
CDVDInputStreamHttp::CDVDInputStreamHttp(const char* strFile) : CDVDInputStream(DVDSTREAM_TYPE_HTTP, strFile)
{
  m_pFile = NULL;
  m_eof = true;
}
...
bool CDVDInputStreamHttp::Open(const std::string& content, bool contentLookup)
{
