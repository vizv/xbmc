...
bool CActiveAE::ResampleSound(CActiveAESound *sound)
{
  ...
  CLog::Log(LOGNOTICE, "ActiveAE::%s 1 - resample %s took %.0fms", __FUNCTION__, sound->m_filename.c_str(), (End-Start)*1e-6);
  Start=End;
  ...
  clock_gettime(CLOCK_MONOTONIC, &now);
  End = ((int64_t)now.tv_sec * 1000000000L) + now.tv_nsec;
  CLog::Log(LOGNOTICE, "ActiveAE::%s 2 - resample %s took %.0fms", __FUNCTION__, sound->m_filename.c_str(), (End-Start)*1e-6);
  Start=End;
  ...
  clock_gettime(CLOCK_MONOTONIC, &now);
  End = ((int64_t)now.tv_sec * 1000000000L) + now.tv_nsec;
  CLog::Log(LOGNOTICE, "ActiveAE::%s 3 - resample %s took %.0fms", __FUNCTION__, sound->m_filename.c_str(), (End-Start)*1e-6);
  Start=End;
  ...
  clock_gettime(CLOCK_MONOTONIC, &now);
  End = ((int64_t)now.tv_sec * 1000000000L) + now.tv_nsec;
  CLog::Log(LOGNOTICE, "ActiveAE::%s 4 - resample %s took %.0fms", __FUNCTION__, sound->m_filename.c_str(), (End-Start)*1e-6);
  Start=End;
  ...
  clock_gettime(CLOCK_MONOTONIC, &now);
  End = ((int64_t)now.tv_sec * 1000000000L) + now.tv_nsec;
  CLog::Log(LOGNOTICE, "ActiveAE::%s 5 - resample %s took %.0fms", __FUNCTION__, sound->m_filename.c_str(), (End-Start)*1e-6);
  Start=End;
