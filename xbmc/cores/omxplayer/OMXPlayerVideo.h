...
public:
  ...
  void ResolutionUpdateCallBack(uint32_t width, uint32_t height, float pixel_aspect, bool deinterlace);
  static void ResolutionUpdateCallBack(void *ctx, uint32_t width, uint32_t height, float pixel_aspect, bool deinterlace);
};
#endif
